...
var ScoreTable = React.createClass({
    ...
    render: function () {
        ...
        this.props.scoreNotes.map(function (scoreItem) {
            ...
            !scoreItem.deleteFlag && scoreNotes.push(<ScoreItem score={scoreItem} onDelete={_this.deleteItemHandler}
                                                                onModify={_this.modifyItem}/>);
        });
    ...
    render: function () {
        ...
        return (
            <tr>
                ...
                <td>{score.chinese}</td>
                <td>{score.math}</td>
                <td><span className="trigger" onClick={this.modifyHandler}>修改</span><span className="trigger"
                                                                                          onClick={this.deleteHandler}>删除</span>
                </td>
            </tr>
        );
    }
